...
# IMPORTANT: Set environment variable FIRST to force CPU backend
import os
os.environ['TI_ARCH'] = 'x64'  # x64 is the CPU backend name for Taichi

# Now initialize Taichi BEFORE any other imports that might use it
import taichi as ti
ti.init(arch=ti.cpu, default_fp=ti.f64)
print("✓ Taichi initialized with CPU backend (f64)")
